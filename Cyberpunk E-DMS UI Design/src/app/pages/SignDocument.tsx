...
import { DocumentCanvas } from "@/app/components/DocumentCanvas";
import { SignaturePad } from "@/app/components/SignaturePad";
import { ChainOfCustody } from "@/app/components/ChainOfCustody";
...
export function SignDocument() {
  ...
  const handleComplete = () => {
    showToast("success", "Document signed successfully! Signature has been verified and stored on the blockchain.");
  };
        ...
        >
          <Link to="/">
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="px-4 md:px-6 py-2.5 md:py-3 text-sm md:text-base rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all"
            >
              Cancel
            </motion.button>
          </Link>
          <motion.button
            ...
            className="px-4 md:px-6 py-2.5 md:py-3 text-sm md:text-base rounded-xl bg-gradient-to-r from-[#6366f1] to-[#a855f7] hover:shadow-lg hover:shadow-[#6366f1]/50 transition-all font-semibold glow-hover"
          >
            Complete Signature
          </motion.button>
        </motion.div>
