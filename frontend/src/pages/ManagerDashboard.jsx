import {
    ...
    Users, AlertCircle, ArrowUpRight, ArrowRight
} from "lucide-react";
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        {pendingDocs.map((doc, i) => (
                            <div key={doc.id} className="flex items-center justify-between p-4 rounded-xl bg-white/5 border border-white/5 hover:border-primary/30 transition-all">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <button className="glass-btn glass-btn-primary py-1.5 px-3 text-xs">
                                        Sign
                                    </button>
                                </div>
                            </div>
                ...
                <div className="glass-card p-6">
                    ...
                    <button className="w-full mt-6 py-2 text-sm text-gray-400 hover:text-white bg-white/5 rounded-lg border border-white/5 hover:bg-white/10 transition-colors">
                        View Department Log
                    </button>
                </div>
