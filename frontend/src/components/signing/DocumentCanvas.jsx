    ...
    return (
        ...
        >
            ...
            <div
                ref={drop}
                id="canvas"
                className={`flex-1 bg-[#1E1E1E] rounded-xl relative overflow-hidden border-2 transition-colors ${isOver ? "border-[#6366f1] bg-[#6366f1]/5" : "border-white/10"
                    }`}
                style={{ transformOrigin: "top left" }}
            >
                <div style={{ transform: `scale(${zoom / 100})`, transformOrigin: "top left", width: '100%', height: '100%' }}>
                    {/* PDF-like document mockup */}
                    <div className="absolute inset-8 bg-white/95 rounded shadow-2xl p-12 overflow-y-auto max-h-full">
